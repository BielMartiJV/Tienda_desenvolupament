...
// ─── PATCH /api/dashboard/admin/comandes/:id/estat ─────────────────────────────
const canviarEstatComanda = async (req, res) => {
  try {
    const { id } = req.params;
...
module.exports = { getUserDashboard, getAdminDashboard, canviarRolUsuari, eliminarUsuari, canviarEstatComanda };
