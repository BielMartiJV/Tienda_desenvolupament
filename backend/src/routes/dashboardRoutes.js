...
// PATCH /api/dashboard/admin/comandes/:id/estat  → canvia l'estat d'una comanda (testeo)
router.patch('/admin/comandes/:id/estat', authMiddleware, roleMiddleware('admin'), canviarEstatComanda);
